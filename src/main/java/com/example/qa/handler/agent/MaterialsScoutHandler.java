 ...
 */
@Component
public class MaterialsScoutHandler implements BusinessChainHandler {

    private static final Logger logger = LoggerFactory.getLogger(MaterialsScoutHandler.class);
